...
package security.webflux.demo.security.utils;
...
public class JwtTokenUtils {
    ...
    public void refleshToken(String token, ServerHttpResponse response) {
        ...
        if (expiration.minusMinutes(10).isBefore(LocalDateTime.now())) {
            ...
            response.getHeaders().set("jwt", this.createToken(jwtSub));
        } else {
            response.getHeaders().set("jwt", token);
        }
